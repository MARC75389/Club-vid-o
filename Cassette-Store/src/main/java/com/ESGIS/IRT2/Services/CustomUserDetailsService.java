...
//        Optional<Abonne> abonne=abonneRepository.findByUserName(username);
//        Caissiere caissiere=caissiereRepository.findByUserName(username);
//
//        if (admin == null && abonne ==null && caissiere == null) {
//            throw new UsernameNotFoundException("User not found");
//        }
//        else if (admin == null && abonne ==null && !(caissiere == null)) {
//                return new User(caissiere.getUserName(), caissiere.getPassword(), getGrantedAuthorities(caissiere.getRole()));
//        }
//        {
